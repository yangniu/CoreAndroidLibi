...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private int indicatorColor = /*0xFF666666*/0Xffda1d09;
	...
	private int scrollOffset = 52;//滚动偏移 要使PagerSlidingTabStrip的滚动速度小于indicator的滚动速度
...
//	private int tabTextSizeLarge = 18;
	private int tabTextColor = /*0xFF666666*/0xFF404040;
	...
	private void updateTabStyles() {
		...
		for (int i = 0; i < tabCount; i++) {
			if (i == pager.getCurrentItem()) {
				updateTextViewStyle(i, indicatorColor,tabTextSize);//初始化
			}else {
				updateTextViewStyle(i,tabTextColor,tabTextSize);
			}
		}
...
//		}
	...
	private class PageListener implements OnPageChangeListener {
		...
		public void onPageSelected(int position) {
			...
			updateTextViewStyle(mLastPosition, tabTextColor, tabTextSize);
//			updateTextViewStyle(pager.getCurrentItem(), indicatorColor,tabTextSizeLarge);滑动变大
			updateTextViewStyle(pager.getCurrentItem(), indicatorColor,tabTextSize);
